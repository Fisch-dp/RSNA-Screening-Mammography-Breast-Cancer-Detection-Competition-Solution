...
class Model(nn.Module):
    def __init__(self, cfg):
        ...
        self.c = nn.Linear(in_features=1280 + 5, out_features=1280, bias=True)
        self.classifier = nn.Linear(in_features=1280, out_features=1, bias=True)
        self.model.classifier = nn.Identity()
        self.auxclassifier1 = nn.Linear(in_features=1280 + 1, out_features=1, bias=True)
