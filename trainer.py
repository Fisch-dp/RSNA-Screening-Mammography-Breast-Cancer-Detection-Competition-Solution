...
class trainer:
    def __init__(self, 
        ...
        if self.mode == "multi":
            self.val_df.sort_values(by=['prediction_id'], inplace=True).reset_index(drop=True)
            self.train_df.sort_values(by=['prediction_id'], inplace=True).reset_index(drop=True)
